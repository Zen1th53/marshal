...
**Evidence Commit:** the commit tagged `v1.5.0` — every gate below was executed against that exact tree. Results from earlier commits are not carried forward.  
...
respectively, and the table above reflects re-execution against the tagged release commit. A
