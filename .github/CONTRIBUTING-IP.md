# Contributor Intellectual Property & Assignment Requirements
...
- **Opening a PR is NOT an IP Transfer**: Submitting a PR does not automatically transfer copyright.
- **Git `Signed-off-by` / DCO is NOT Assignment**: A DCO signature or Git sign-off line is a license representation, not a copyright assignment.
- **Third-Party Material**: All third-party dependencies, copied snippets, or AI-generated output must be disclosed in the PR template.

For detailed instructions, see [`docs/legal/CONTRIBUTOR-ONBOARDING.md`](../docs/legal/CONTRIBUTOR-ONBOARDING.md).
