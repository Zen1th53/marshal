# Commercial License Agreement Checklist
...
- [ ] **License Fees**: One-time fee, recurring subscription, per-seat, per-core, or royalty structure.
- [ ] **Payment Terms**: Invoice schedule, payment currency, tax allocation, and late payment terms.
- [ ] **Audit Rights**: Terms for auditing Licensee's compliance with deployment limits, if applicable.
...
- [ ] **Liability Caps**: Direct and consequential damages liability caps.

---

## 5. Term, Termination & Transition

- [ ] **Agreement Term**: Effective date and expiration/renewal criteria.
- [ ] **Termination for Cause**: Notice period and cure mechanism for material breach.
- [ ] **Effect of Termination**: Post-termination rights regarding previously distributed OEM units or deployed internal instances.

---

## 6. Miscellaneous & Governance

- [ ] **Governing Law**: Choice of law and legal jurisdiction.
- [ ] **Dispute Resolution**: Arbitration or litigation forum.
- [ ] **Assignment & Successor Rights**: Licensor's right to assign the agreement to a successor entity or acquiring company.
- [ ] **Entire Agreement**: Integration clause overriding prior informal communications.
