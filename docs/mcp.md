...
All MCP HTTP endpoints require Bearer authentication using high-entropy tokens generated by the SLAVES control plane.

### Generating a Token
```bash
slaves auth token create --name mcp-orchestrator
```

Output:
```text
Created Token ID: TOKEN-e6eeb825c43740c7
Plaintext Token: slaves_token_6e86f061e255da6d5b075084e08c3ff7821002ad9d02b250bee90024ab0e63d0
...
### Start Server
```bash
slaves mcp serve --listen 127.0.0.1:8080
```
...
MCP requests do **not** bypass SLAVES security controls:
