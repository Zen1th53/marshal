...
go build -ldflags="-X 'github.com/Zen1th53/marshal/internal/version.Version=v1.0.1' -X 'github.com/Zen1th53/marshal/internal/version.Commit=$(git rev-parse --short HEAD)' -X 'github.com/Zen1th53/marshal/internal/version.BuildDate=$(date -u +%Y-%m-%d)'" -o bin/marshal ./cmd/marshal
