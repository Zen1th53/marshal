...
var (
	ErrBackendDisabled = errors.New("turbovec optional backend is disabled")
)
...
func (b *Backend) Name() string    { return "turbovec-optional" }
func (b *Backend) Version() string { return "0.9.0-experimental" }

func (b *Backend) SimulateCrash() {
	b.mu.Lock()
	defer b.mu.Unlock()
	b.crashed = true
	// Auto-recovery
...
func (b *Backend) Health(ctx context.Context) error {
	...
	if b.crashed {
		return errors.New("backend process crashed")
	}
	return nil
}
