...
func (s *Server) handleGetReleaseTrust(w http.ResponseWriter, r *http.Request) {
	artifacts := []TrustArtifactDTO{
		{
			Name:         "PACK-MANIFEST.json",
			DigestSHA256: "978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb22",
			SizeBytes:    8192,
			DownloadPath: "/distribution/PACK-MANIFEST.json",
		},
		{
			Name:         "sbom.cyclonedx.json",
			DigestSHA256: "3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855aa",
			SizeBytes:    45056,
			DownloadPath: "/distribution/sbom.cyclonedx.json",
		},
		{
			Name:         "release.signature.bundle",
			DigestSHA256: "7783f84ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb33",
			SizeBytes:    1024,
	...
	writeJSON(w, http.StatusOK, ReleaseTrustReportDTO{
		BinaryCommitSHA:       "7550994",
		SourceRepo:            "github.com/Zen1th53/marshal",
		PackManifestStatus:    "VERIFIED_PASS",
		PackManifestDigest:    "978112ca1bbdcafac231b39a23dc4da786eff8147c4e72b9807785afee48bb22",
