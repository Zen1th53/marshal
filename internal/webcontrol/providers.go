...
func (s *Server) handleGetProviders(w http.ResponseWriter, r *http.Request) {
	if s.store != nil {
		writeError(w, http.StatusNotImplemented, "unsupported_live_surface", "live provider routing inventory is not implemented; use marshal adapters or marshal doctor --probe-providers", "")
		return
	}
...
func (s *Server) handleOverrideRouter(w http.ResponseWriter, r *http.Request) {
	if s.store != nil {
		writeError(w, http.StatusNotImplemented, "unsupported_live_surface", "adaptive provider routing is not part of the Community runtime", "")
		return
	}
