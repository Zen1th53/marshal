...
// Capability defines a single user-operable feature across CLI, Web, and TUI.
type Capability struct {
	...
	WebSurface    string     // Web Control Plane route equivalent
...
// AuditParity verifies that all capabilities are mapped to TUI with zero CLI-only or Web-only gaps.
...
func registerAllCapabilities(r *CapabilityRegistry) {
	...
	r.Register(Capability{ID: "optimization.cycle.status", Category: "OPTIMIZATION", Name: "Inspect Process 08 optimization cycle", Description: "Read a canonical optimization cycle with its vetoes and blocked paths", Access: AccessRead, CLISurface: "marshal optimization show OPTIMIZATION-ID", WebSurface: "GET /api/v1/optimization/cycles/:id", TUISurface: "/optimization <optimization_id>", PalettePath: "optimization cycle"})
	r.Register(Capability{ID: "optimization.candidates", Category: "OPTIMIZATION", Name: "Inspect optimization candidates", Description: "List candidates with their declared effects and cluster identity", Access: AccessRead, CLISurface: "marshal optimization candidates OPTIMIZATION-ID", WebSurface: "GET /api/v1/optimization/cycles/:id/candidates", TUISurface: "/optimization <optimization_id>", PalettePath: "optimization candidates"})
	r.Register(Capability{ID: "optimization.counterfactuals", Category: "OPTIMIZATION", Name: "Inspect counterfactual evaluations", Description: "Read alternate-route comparisons with their stated limitations", Access: AccessRead, CLISurface: "marshal optimization counterfactuals OPTIMIZATION-ID", WebSurface: "GET /api/v1/optimization/cycles/:id/counterfactuals", TUISurface: "/optimization <optimization_id>", PalettePath: "optimization counterfactuals"})
	r.Register(Capability{ID: "optimization.manifests", Category: "OPTIMIZATION", Name: "Inspect benchmark manifests", Description: "Read pinned benchmark provenance, including which runs were official", Access: AccessRead, CLISurface: "marshal optimization manifests OPTIMIZATION-ID", WebSurface: "GET /api/v1/optimization/cycles/:id/manifests", TUISurface: "/optimization <optimization_id>", PalettePath: "optimization manifests"})
	r.Register(Capability{ID: "optimization.canaries", Category: "OPTIMIZATION", Name: "Inspect canary rollouts", Description: "Read bounded rollouts, their triggers and their rollback reasons", Access: AccessRead, CLISurface: "marshal optimization canaries OPTIMIZATION-ID", WebSurface: "GET /api/v1/optimization/cycles/:id/canaries", TUISurface: "/rollback <canary_id>", PalettePath: "optimization canaries"})
	r.Register(Capability{ID: "learning.commit.status", Category: "LEARNING", Name: "Inspect Process 07 memory commit", Description: "Read a canonical memory commit with its promotions and refusals", Access: AccessRead, CLISurface: "marshal learning show MEMORY-COMMIT-ID", WebSurface: "GET /api/v1/learning/memory-commits/:id", TUISurface: "/learning <memory_commit_id>", PalettePath: "learning commit"})
	r.Register(Capability{ID: "learning.memory.search", Category: "LEARNING", Name: "Search durable memory", Description: "Bounded, scope- and freshness-aware memory retrieval with contradiction signals", Access: AccessRead, CLISurface: "marshal learning search --project ID", WebSurface: "GET /api/v1/learning/memory", TUISurface: "/memory-search <project_id>", PalettePath: "learning search"})
	r.Register(Capability{ID: "learning.memory.provenance", Category: "LEARNING", Name: "Inspect memory provenance", Description: "Read one memory item's full immutable version history", Access: AccessRead, CLISurface: "marshal learning history ITEM-ID", WebSurface: "GET /api/v1/learning/memory/:id/provenance", TUISurface: "/provenance <item_id>", PalettePath: "learning provenance"})
	r.Register(Capability{ID: "learning.routing.trust", Category: "LEARNING", Name: "Inspect routing trust", Description: "Measured routing outcomes including failures, blocked runs and selection bias", Access: AccessRead, CLISurface: "marshal learning trust TASK-CLASS", WebSurface: "GET /api/v1/learning/routing-trust", TUISurface: "/trust [task-class]", PalettePath: "learning trust"})
	r.Register(Capability{ID: "learning.fingerprints", Category: "LEARNING", Name: "Inspect failure fingerprints", Description: "Bounded, freshness-aware failure fingerprints", Access: AccessRead, CLISurface: "marshal learning fingerprints --project ID", WebSurface: "GET /api/v1/learning/fingerprints", TUISurface: "/fingerprints <project_id>", PalettePath: "learning fingerprints"})
	r.Register(Capability{ID: "learning.playbooks", Category: "LEARNING", Name: "Inspect playbook candidates", Description: "List candidate procedures awaiting review; candidates are never active", Access: AccessRead, CLISurface: "marshal learning playbooks --project ID", WebSurface: "GET /api/v1/learning/playbook-candidates", TUISurface: "/playbooks <project_id>", PalettePath: "learning playbooks"})
	r.Register(Capability{ID: "learning.replay.index", Category: "LEARNING", Name: "Inspect replay index", Description: "Read reproducibility classes and the side effects that block automatic replay", Access: AccessRead, CLISurface: "marshal learning replays RUN-ID", WebSurface: "GET /api/v1/learning/replay-index", TUISurface: "/replay-index [run_id]", PalettePath: "learning replay"})
	r.Register(Capability{ID: "learning.benchmarks", Category: "LEARNING", Name: "Inspect benchmark records", Description: "Read reproducible evaluation records pinned to a benchmark version and tree", Access: AccessRead, CLISurface: "marshal learning benchmarks NAME", WebSurface: "GET /api/v1/learning/benchmarks", TUISurface: "/replay-index", PalettePath: "learning benchmarks"})
	// 1. Goal Domain (12)
	r.Register(Capability{
		ID: "goal.create", Category: "GOAL", Name: "Create Goal",
		Description: "Initialize a new goal with objectives and criteria",
		Access:      AccessWrite, CLISurface: "marshal goal create", WebSurface: "POST /api/goal",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal goal", WebSurface: "GET /api/goal",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal goal edit", WebSurface: "PUT /api/goal",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal goal version", WebSurface: "GET /api/goal/version",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal goal diff", WebSurface: "GET /api/goal/diff",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal goal criteria", WebSurface: "GET /api/goal/criteria",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal goal constraints", WebSurface: "GET /api/goal/constraints",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal goal add-constraint", WebSurface: "POST /api/goal/constraints",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal goal rm-constraint", WebSurface: "DELETE /api/goal/constraints",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal goal donotdo", WebSurface: "GET /api/goal/donotdo",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal agents", WebSurface: "GET /api/agents",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal agents inspect", WebSurface: "GET /api/agents/:id",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal agents add", WebSurface: "POST /api/agents",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal agents remove", WebSurface: "DELETE /api/agents/:id",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal agents toggle", WebSurface: "PUT /api/agents/:id/toggle",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal agents role", WebSurface: "PUT /api/agents/:id/role",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal msg @agent", WebSurface: "POST /api/messages",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal msg @team", WebSurface: "POST /api/messages/broadcast",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal pause @agent", WebSurface: "POST /api/agents/:id/pause",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal handoff", WebSurface: "POST /api/handoffs",
	...
	r.Register(Capability{
		...
		Access:      AccessExecute, CLISurface: "marshal harness probe", WebSurface: "POST /api/harness/probe",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal harness status", WebSurface: "GET /api/harness",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal harness select", WebSurface: "PUT /api/harness/select",
		TUISurface: "/harness select", KeyboardPath: "h l", PalettePath: "harness select",
	})
	r.Register(Capability{
		ID: "model.select", Category: "HARNESS", Name: "Select Model",
		Description: "Unavailable until Runtime provides an authenticated execution-profile service",
		Access:      AccessWrite, CLISurface: "marshal model select", WebSurface: "PUT /api/model/select",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal mode select", WebSurface: "PUT /api/harness/mode",
	...
	r.Register(Capability{
		...
		Description: "Unavailable until Runtime provides an authenticated execution-profile service",
		Access:      AccessWrite, CLISurface: "marshal effort", WebSurface: "PUT /api/harness/effort",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal policy tool", WebSurface: "PUT /api/policy/tools",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal context strategy", WebSurface: "PUT /api/context/strategy",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal ultra", WebSurface: "GET /api/ultra/status",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal route", WebSurface: "GET /api/routing",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal claims", WebSurface: "GET /api/claims",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal inspect C-...", WebSurface: "GET /api/claims/:id",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal claims graph", WebSurface: "GET /api/claims/graph",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal claims challenge", WebSurface: "POST /api/claims/:id/challenge",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal claims verify", WebSurface: "POST /api/claims/:id/verify",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal claims deps", WebSurface: "GET /api/claims/:id/deps",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal claims history", WebSurface: "GET /api/claims/:id/history",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal claims coverage", WebSurface: "GET /api/claims/coverage",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal evidence", WebSurface: "GET /api/evidence",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal evidence inspect E-...", WebSurface: "GET /api/evidence/:id",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal evidence filter", WebSurface: "GET /api/evidence?filter=...",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal evidence stale", WebSurface: "GET /api/evidence/stale",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal evidence contradictions", WebSurface: "GET /api/evidence/contradictions",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal evidence reverify", WebSurface: "POST /api/evidence/:id/reverify",
	...
	r.Register(Capability{
		...
		Access:      AccessExecute, CLISurface: "marshal export evidence", WebSurface: "POST /api/evidence/export",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal evidence bundle", WebSurface: "GET /api/evidence/bundle",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal alignment scope", WebSurface: "GET /api/alignment/scope",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal alignment violations", WebSurface: "GET /api/alignment/violations",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal alignment blast", WebSurface: "GET /api/alignment/blast",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal alignment deletions", WebSurface: "GET /api/alignment/deletions",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal alignment resolve", WebSurface: "POST /api/alignment/resolve",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal alignment status", WebSurface: "GET /api/alignment",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal checkpoint list", WebSurface: "GET /api/checkpoints",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal checkpoint create", WebSurface: "POST /api/checkpoints",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal checkpoint inspect CP-...", WebSurface: "GET /api/checkpoints/:id",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal checkpoint diff CP-...", WebSurface: "GET /api/checkpoints/:id/diff",
	...
	r.Register(Capability{
		...
		Access:      AccessExecute, CLISurface: "marshal rollback CP-...", WebSurface: "POST /api/checkpoints/:id/rollback",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal rollback cancel", WebSurface: "POST /api/checkpoints/rollback/cancel",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal rollback history", WebSurface: "GET /api/checkpoints/rollback/history",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal budget", WebSurface: "GET /api/budget",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal budget cost <amount>", WebSurface: "PUT /api/budget/cost",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal budget tokens <count>", WebSurface: "PUT /api/budget/tokens",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal budget time <duration>", WebSurface: "PUT /api/budget/time",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal budget calls <count>", WebSurface: "PUT /api/budget/calls",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal termination", WebSurface: "GET /api/termination",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal approvals", WebSurface: "GET /api/approvals",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal approval inspect <id>", WebSurface: "GET /api/approvals/:id",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal approval diff <id>", WebSurface: "GET /api/approvals/:id/diff",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal approve <id>", WebSurface: "POST /api/approvals/:id/approve",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal reject <id>", WebSurface: "POST /api/approvals/:id/reject",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal approvals history", WebSurface: "GET /api/approvals/history",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal tasks", WebSurface: "GET /api/tasks",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal task create", WebSurface: "POST /api/tasks",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal task inspect T-...", WebSurface: "GET /api/tasks/:id",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal task retry", WebSurface: "POST /api/tasks/:id/retry",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal task ownership", WebSurface: "GET /api/tasks/ownership",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal policy network", WebSurface: "GET /api/policy/network",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal sandbox", WebSurface: "GET /api/sandbox",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal policy capability", WebSurface: "GET /api/policy/capability",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal policy scope", WebSurface: "GET /api/policy/scope",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal policy write", WebSurface: "GET /api/policy/write",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal policy audit", WebSurface: "GET /api/policy/audit",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal provider status", WebSurface: "GET /api/providers",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal provider config", WebSurface: "PUT /api/providers/:id",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal memory", WebSurface: "GET /api/memory",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal memory search <query>", WebSurface: "GET /api/memory/search",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal memory provenance", WebSurface: "GET /api/memory/provenance",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal blind status", WebSurface: "GET /api/blind",
	...
	r.Register(Capability{
		...
		Access:      AccessWrite, CLISurface: "marshal blind resolve", WebSurface: "POST /api/blind/resolve",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal reinjection", WebSurface: "GET /api/reinjection",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal doctor", WebSurface: "GET /api/doctor",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal runtime", WebSurface: "GET /api/runtime",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal store", WebSurface: "GET /api/store",
	...
	r.Register(Capability{
		...
		Access:      AccessExecute, CLISurface: "marshal backup create", WebSurface: "POST /api/backup",
	...
	r.Register(Capability{
		...
		Access:      AccessExecute, CLISurface: "marshal backup restore <id>", WebSurface: "POST /api/backup/restore",
	...
	r.Register(Capability{
		...
		Access:      AccessRead, CLISurface: "marshal fingerprint", WebSurface: "GET /api/fingerprint",
