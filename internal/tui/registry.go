...
func registerAllCapabilities(r *CapabilityRegistry) {
	...
	r.Register(Capability{
		...
		Description: "Assign a specific harness to a role or task",
	...
	r.Register(Capability{
		...
		Description: "Choose specific model for a harness",
	...
	r.Register(Capability{
		...
		Description: "Adjust native reasoning effort (low/med/high)",
	...
	r.Register(Capability{
		ID: "ultra.toggle", Category: "HARNESS", Name: "Toggle ULTRA Mode",
		Description: "Enable or disable ULTRA autonomous optimization",
		Access: AccessWrite, CLISurface: "marshal ultra toggle", WebSurface: "POST /api/ultra/toggle",
	...
	r.Register(Capability{
		...
		Description: "Safely revert worktree, claims, and goal to checkpoint",
